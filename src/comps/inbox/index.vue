...
module.exports = {
  route: {
    ...
    // activate with beforeActicate
    canDeacticate(transition) {
      return comfrim('Are you sure you want to leave inbox')
    },

    // activate hook is called when the route si matched
